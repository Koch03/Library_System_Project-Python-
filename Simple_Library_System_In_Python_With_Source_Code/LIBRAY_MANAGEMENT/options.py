        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    # label and input box
                    self.label3 = Label(self, text='LIBRARY MANAGEMENT SYSTEM', fg='black', bg="gray",
                    ...
                    Button(self, text='Search', width=15, font=('arial', 10), command=ser).place(x=1000,
                                                                                                 y=106)
                    ...
                    Button(self, text='Find', width=15, font=('arial', 10), command=ent).place(x=1000, y=150)
                    self.label6 = Label(self, text="INFORMATION DETAILS", bg="gray",
                                        font=('Courier new', 15, 'underline', 'bold'))
                    self.label6.place(x=560, y=300)
                    Button(self, text='Search Student', width=25, font=('Courier new', 10),
                           command=sest).place(x=240, y=250)
                    Button(self, text='Search Book', width=25, font=('Courier new', 10),
                           command=sea).place(x=520, y=250)
                    Button(self, text="Issue Book", width=15, font=('Courier new', 10), command=ib).place(
                        x=800, y=250)
                    Button(self, text="Return Book", width=15, font=('Courier new', 10), command=ret).place(
                        x=1000, y=250)
                    Button(self, text="LOGOUT", width=15, bg="red", font=('Courier new', 10),
                           command=log).place(x=1150, y=105)
            except Error:
                messagebox.showerror("Error", "Something Goes Wrong")
