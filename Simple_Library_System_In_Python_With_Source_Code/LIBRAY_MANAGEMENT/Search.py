...
class Search(Tk):
    def __init__(self):
        ...
        Button(self, text="Find", width=15, bg='gray', font=("Courier new", 10, 'bold'), command=ge).place(x=460, y=148)
        ttk.Combobox(self, textvariable=g, values=["Book Name", "Author Name", "Book Id"], width=40,
                     state="readonly").place(x=180, y=100)
        Entry(self, textvariable=f, width=43).place(x=180, y=155)
        Label(self, text="Enter", bg='gray', font=("Courier new", 15, 'bold')).place(x=100, y=150)
